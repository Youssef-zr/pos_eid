            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-list"></i> {{ trans('lang.roles_list') }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <div class="card card-primary card-outline">
        <div class="card-body">
            ...
            <div class="actions d-flex">
                ...
                <!-- new record -->
                <div id="add-new">
                    <a href="{{ route('dashboard.roles.create') }}" class="btn btn-primary btn-flat">
            ...
            <section class="content">
                                            ...
                                            <div class="dropdown-menu" role="menu" style="">
                                                ...
                                                <label class="dropdown-item mb-0">
                                                    <a href="#"
                                                        ...
                                                        data-id="{{ $role->id }}" title='{{ trans('lang.delete') }}'
                                                        data-toggle="tooltip" data-modal="deleteRole">
                ...
                <!-- Modal Remove role-->
                <div class="modal text-left" id="deleteRole" style="overflow: hidden">
                        ...
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="close hide-modal" data-modal="deleteRole">
                                ...
                                <div class="modal-footer" style="text-align: center !important">
                                    <form action="" data-url="{{ adminUrl('roles') }}" method="post"
