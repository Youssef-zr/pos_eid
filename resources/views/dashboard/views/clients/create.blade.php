          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{adminurl('clients')}}"><i class="fa fa-list"></i> {{ trans('lang.clients_list') }}</a></li>
            ...
            <div class="col-xl-12">
              <div class="card card-primary mg-b-20">
                <div class="card-header">
                    <h4 class="title"><i class="fa fa-plus-circle"></i> {{ trans('lang.clients_new') }} </h4>
                </div>
                <div class="card-body">
