            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-tags"></i> {{ trans('lang.categories_list') }}
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="actions d-flex">
                ...
                @permission('create_categories')
                    <div id="add-new">
                        <a href="{{ route('dashboard.categories.create') }}" class="btn btn-primary btn-flat">
            ...
            <section class="content">
                <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <table id="example" class="stripe row-border order-column text-capitalize w-100">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>{{ trans('lang.' . app()->getLocale() . '.name') }}</th>
                                <th>{{ trans('lang.related_products') }}</th>

                                <!-- check category has permission to update and delete category -->
                                @permission(['update_categories', 'delete_categories'])
                        ...
                        <tbody>
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $class_color = $category->products_count > 0 ? 'success' : 'danger';
                                        @endphp
                                        <a href="{{ route('dashboard.categories.products',$category->id)}}" class="badge bg-{{ $class_color }}">
                                            @lang('lang.related_products') {{ $category->products_count}}
                                        </a>
                                    </td>

                                    <!-- check category has permission to update or delete -->
                                    @permission(['update_categories', 'delete_categories'])
                                        <td>
                                            <div class="btn-group">
                                                <button type="button"
                                                ...
                                                <div class="dropdown-menu" role="menu" style="">
                                                    ...
                                                    @permission('update_categories')
                                                        <label class="dropdown-item mb-0">
                                                            <a href="{{ adminurl('categories/' . $category->id . '/edit') }}"
                                                    ...
                                                    @permission('delete_categories')
                                                        <label class="dropdown-item mb-0">
                                                            <a href="#"
                                                                ...
                                                                data-id="{{ $category->id }}" title='{{ trans('lang.delete') }}'
                                                                data-toggle="tooltip" data-modal="deletecategory">
                ...
                @permission('delete_categories')
                    <div class="modal text-left" id="deletecategory" style="overflow: hidden">
                            ...
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="close hide-modal" data-modal="deletecategory"><i
                                    ...
                                    <div class="modal-footer" style="text-align: center !important">
                                        <form action="" data-url="{{ adminUrl('categories') }}" method="post"
